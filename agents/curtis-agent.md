...
You own a slice of a brief, not the brief. Return file pointers and a short summary, not raw dumps. Verify on the real artifact before reporting done. Never push, never run `migrate:fresh`, never move vault files; those stop at the parent.
